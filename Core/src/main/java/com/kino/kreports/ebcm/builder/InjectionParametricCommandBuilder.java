package com.kino.kreports.ebcm.builder;
...
public class InjectionParametricCommandBuilder implements ParametricCommandBuilder {
        ...
        if (commandAnnotation != null) {
            ...
            if (classesAnnotation != null) {
                for (Class<? extends CommandClass> subCommandClass : classesAnnotation.value()) {
                    ...
                    try {
                        List<Command> subCommands = fromClass(createSubCommandInstance(subCommandClass));
    ...
    private CommandClass createSubCommandInstance(Class<? extends CommandClass> clazz) {
