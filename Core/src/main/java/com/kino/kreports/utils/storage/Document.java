...
public class Document {
    ...
    public <T> T getObject(String key,Class<T> classof){
        ...
        return GsonUtil.GSON.fromJson(this.datas.get(key),classof);
    }

    public <T> T getObject(String key, Type type) {
        return GsonUtil.GSON.fromJson(datas.get(key), type);
    }
    ...
    public Document append(String key, Object value){
        if(value != null) this.datas.add(key, GsonUtil.GSON.toJsonTree(value));
        return this;
    }
    ...
    public Document appendDefault(String key, Object value){
        if(contains(key) || value == null) return this;
        this.datas.add(key, GsonUtil.GSON.toJsonTree(value));
        return this;
    }
    ...
    public void saveDataSave(File file) throws Exception{
        ...
        GsonUtil.GSON.toJson(this.datas,writer);
        writer.close();
    }
    ...
    public static Document loadDataSave(String jsonString) throws Exception{
        return new Document(GsonUtil.PARSER.parse(new StringReader(jsonString)).getAsJsonObject());
    }
    ...
    public static Document loadDataSave(File file) throws Exception{
        ...
        JsonObject datas = GsonUtil.PARSER.parse(bufferedreader).getAsJsonObject();
